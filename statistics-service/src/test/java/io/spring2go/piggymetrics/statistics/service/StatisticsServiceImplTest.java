...
import io.spring2go.piggymetrics.statistics.domain.Item;
import io.spring2go.piggymetrics.statistics.domain.Saving;
import io.spring2go.piggymetrics.statistics.domain.TimePeriod;
import io.spring2go.piggymetrics.statistics.domain.timeseries.DataPoint;
import io.spring2go.piggymetrics.statistics.domain.timeseries.ItemMetric;
import io.spring2go.piggymetrics.statistics.domain.timeseries.StatisticMetric;
import io.spring2go.piggymetrics.statistics.repository.DataPointRepository;
